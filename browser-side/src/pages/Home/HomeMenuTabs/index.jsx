...
const HomeMenuTabs = ({ arrTheater }) => {
    ...
    //     const gioChieuRender = lstlCTP.filter(item => {
    ...
    console.log(NotDuplicateArrayShowDay)
                                ...
                                return (
                                    <div key={index} className="grid grid-cols-4" >
                                        ...
                                        <div className="text-left col-span-3">
                                            ...
                                            <div>
                                                {NotDuplicateArrayShowDay.slice(0, 5).map((date, index) => {
                                                    return (
                                                        date.slice(0, 5).map((day) => {
                                                            return (
                                                                <Fragment>
                                                                    <p className="
